...
const assetsURL = function(dep) {
  return "/DEV010-social-network/" + dep;
};
const seen = {};
...
Check out your Vite / network configuration and https://vitejs.dev/config/server-options.html#server-hmr .`);
  ...
  console.error(`[vite] failed to connect to websocket (${error2}). `);
}
...
async function fetchUpdate({ path, acceptedPath, timestamp, explicitImportRequired }) {
  ...
  if (isSelfUpdate || qualifiedCallbacks.length > 0) {
    ...
    const [path2, query2] = dep.split(`?`);
    try {
      const newMod = await __vitePreload(() => import(base + path2.slice(1) + `?${explicitImportRequired ? "import&" : ""}t=${timestamp}${query2 ? `&${query2}` : ""}`), true ? [] : void 0);
...
function start(navigateTo2) {
  ...
  sectionOne.append(title, button);
  return sectionOne;
}
/**
 * @license
...
function rc(a, b2, c) {
  ...
  a.i = a.i && d;
  d ? 0 < c.length && !a.ba && (a.ba = true, b2 = a.l, b2.g == a && b2.ca && !b2.M && (b2.l.info("Great, no buffering proxy detected. Bytes received: " + c.length), vc(b2), b2.M = true, F(11))) : (D$1(
    a.j,
    a.m,
    c,
...
async function __PRIVATE_ignoreIfPrimaryLeaseLoss(e) {
  if (e.code !== D.FAILED_PRECONDITION || e.message !== v)
    throw e;
...
class __PRIVATE_QueryImpl {
  constructor(e, t = null, n = [], r2 = [], i = null, s = "F", o = null, _ = null) {
    this.path = e, this.collectionGroup = t, this.explicitOrderBy = n, this.filters = r2, this.limit = i, this.limitType = s, this.startAt = o, this.endAt = _, this.Pe = null, this.Ie = null, this.de = null, this.startAt, this.endAt;
  }
}
...
class __PRIVATE_TargetState {
  constructor() {
    this.we = 0, this.Se = __PRIVATE_snapshotChangesMap(), this.be = ByteString.EMPTY_BYTE_STRING, this.De = false, this.Ce = true;
  }
  get current() {
    return this.De;
  }
...
class __PRIVATE_WatchChangeAggregator {
    ...
    this.forEachTarget(e, (t) => {
      ...
      switch (e.state) {
        case 0:
          ...
          break;
        case 1:
          n.ke(), n.ve || n.Oe(), n.Me(e.resumeToken);
          break;
        case 2:
  ...
  je(e, t, n) {
    if (!this.Ye(e))
      return;
    const r2 = this.Je(e);
    this.ut(e, t) ? r2.Ne(t, 1) : r2.Be(t), this.Ue = this.Ue.insert(t, this.ct(t).delete(e)), n && (this.$e = this.$e.insert(t, n));
  }
  removeTarget(e) {
    this.Ke.delete(e);
  }
  ...
  getDocumentsMatchingCollectionQuery(e, t, n, r2) {
    ...
    return this.documentOverlayCache.getOverlaysForCollection(e, t.path, n.largestBatchId).next((s) => (i = s, this.remoteDocumentCache.getDocumentsMatchingQuery(e, t, n, i, r2))).next((e2) => {
      ...
      return e2.forEach((e3, r3) => {
        const s = i.get(e3);
        void 0 !== s && __PRIVATE_mutationApplyToLocalView(s.mutation, r3, FieldMask.empty(), Timestamp.now()), __PRIVATE_queryMatches(t, r3) && (n2 = n2.insert(e3, r3));
      }), n2;
    });
  }
}
...
class __PRIVATE_ReferenceSet {
  constructor() {
    this.Ir = new SortedSet(__PRIVATE_DocReference.dr), this.Tr = new SortedSet(__PRIVATE_DocReference.Er);
  }
  isEmpty() {
...
class __PRIVATE_MemoryMutationQueue {
  constructor(e, t) {
    this.indexManager = e, this.referenceDelegate = t, this.mutationQueue = [], this.wr = 1, this.Sr = new SortedSet(__PRIVATE_DocReference.dr);
  }
  checkEmpty(e) {
  ...
  getAllMutationBatchesAffectingQuery(e, t) {
    ...
    return this.Sr.forEachWhile((e2) => {
      ...
      return !!n.isPrefixOf(t2) && (t2.length === r2 && (o = o.add(e2.yr)), true);
...
class __PRIVATE_MemoryRemoteDocumentCacheImpl {
  constructor(e) {
    this.Fr = e, this.docs = function __PRIVATE_documentEntryMap() {
      return new SortedMap(DocumentKey.comparator);
    }(), this.size = 0;
  }
  setIndexManager(e) {
...
class __PRIVATE_MemoryTargetCache {
  constructor(e) {
    this.persistence = e, this.Or = new ObjectMap((e2) => __PRIVATE_canonifyTarget(e2), __PRIVATE_targetEquals), this.lastRemoteSnapshotVersion = SnapshotVersion.min(), this.highestTargetId = 0, this.Nr = 0, this.Br = new __PRIVATE_ReferenceSet(), this.targetCount = 0, this.Lr = __PRIVATE_TargetIdGenerator.Bn();
  }
  forEachTarget(e, t) {
...
class __PRIVATE_MemoryEagerDelegate {
  constructor(e) {
    this.persistence = e, this.jr = new __PRIVATE_ReferenceSet(), this.Hr = null;
  }
  static Jr(e) {
...
class __PRIVATE_QueryEngine {
  constructor() {
    this.Ui = false, this.Wi = false, this.Gi = 100, this.zi = 2;
  }
  initialize(e, t) {
  ...
  Hi(e, t) {
    ...
    return this.indexManager.getIndexType(e, n).next((r2) => 0 === r2 ? null : (null !== t.limit && 1 === r2 && (t = __PRIVATE_queryWithLimit(t, null, "F"), n = __PRIVATE_queryToTarget(t)), this.indexManager.getDocumentsMatchingTarget(e, n).next((r3) => {
      ...
      return this.ji.getDocuments(e, i).next((r4) => this.indexManager.getMinOffset(e, n).next((n2) => {
        ...
        return this.es(t, s, i, n2.readTime) ? this.Hi(e, __PRIVATE_queryWithLimit(t, null, "F")) : this.ts(e, s, t, n2);
      }));
    })));
  }
  Ji(e, t, n, r2) {
  ...
  ts(e, t, n, r2) {
    return this.ji.getDocumentsMatchingQuery(e, n, r2).next((e2) => (t.forEach((t2) => {
...
class __PRIVATE_LocalStoreImpl {
  constructor(e, t, n, r2) {
    this.persistence = e, this.ns = t, this.serializer = r2, this.rs = new SortedMap(__PRIVATE_primitiveComparator), this.ss = new ObjectMap((e2) => __PRIVATE_canonifyTarget(e2), __PRIVATE_targetEquals), this.os = /* @__PURE__ */ new Map(), this._s = e.getRemoteDocumentCache(), this.Kr = e.getTargetCache(), this.Ur = e.getBundleCache(), this.us(n);
  }
  us(e) {
...
class __PRIVATE_WebChannelConnection extends class __PRIVATE_RestConnection {
  ...
  Mo(e, t, n) {
    ...
    void 0 !== a && (_.longPollingTimeout = Math.round(1e3 * a)), this.useFetchStreams && (_.useFetchStreams = true), this.Co(_.initMessageHeaders, t, n), _.encodeInitMessageHeaders = true;
    const u = i.join("");
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      h || (h = true, __PRIVATE_logWarn(Ve, `RPC '${e}' stream ${r2} transport errored:`, t2), P2.mo(new FirestoreError(D.UNAVAILABLE, "The operation could not be completed")));
      ...
      if (!h) {
        ...
        if (o2) {
          ...
          void 0 === n3 && (n3 = D.INTERNAL, i3 = "Unknown error status: " + t3 + " with message " + o2.message), h = true, P2.mo(new FirestoreError(n3, i3)), c.close();
        } else
...
class __PRIVATE_ExponentialBackoff {
  constructor(e, t, n = 1e3, r2 = 1.5, i = 6e4) {
    this._i = e, this.timerId = t, this.xo = n, this.Oo = r2, this.No = i, this.Bo = 0, this.Lo = null, this.ko = Date.now(), this.reset();
  }
  reset() {
    this.Bo = 0;
  }
  ...
  Qo(e) {
    ...
    r2 > 0 && __PRIVATE_logDebug("ExponentialBackoff", `Backing off for ${r2} ms (base delay: ${this.Bo} ms, delay with jitter: ${t} ms, last attempt: ${n} ms ago)`), this.Lo = this._i.enqueueAfterDelay(this.timerId, r2, () => (this.ko = Date.now(), e())), this.Bo *= this.Oo, this.Bo < this.xo && (this.Bo = this.xo), this.Bo > this.No && (this.Bo = this.No);
  }
  $o() {
...
class __PRIVATE_PersistentStream {
  constructor(e, t, n, r2, i, s, o, _) {
    this._i = e, this.Uo = n, this.Wo = r2, this.connection = i, this.authCredentialsProvider = s, this.appCheckCredentialsProvider = o, this.listener = _, this.state = 0, this.Go = 0, this.zo = null, this.jo = null, this.stream = null, this.Ho = new __PRIVATE_ExponentialBackoff(e, t);
  }
  Jo() {
...
class __PRIVATE_PersistentWriteStream extends __PRIVATE_PersistentStream {
  ...
  onMessage(e) {
    if (__PRIVATE_hardAssert(!!e.streamToken), this.lastStreamToken = e.streamToken, this.P_) {
      this.Ho.reset();
...
class __PRIVATE_OnlineStateTracker {
  constructor(e, t) {
    this.asyncQueue = e, this.onlineStateHandler = t, this.state = "Unknown", this.f_ = 0, this.g_ = null, this.p_ = true;
  }
  y_() {
    0 === this.f_ && (this.w_("Unknown"), this.g_ = this.asyncQueue.enqueueAfterDelay("online_state_timeout", 1e4, () => (this.g_ = null, this.S_("Backend didn't respond within 10 seconds."), this.w_("Offline"), Promise.resolve())));
  }
  b_(e) {
    "Online" === this.state ? this.w_("Unknown") : (this.f_++, this.f_ >= 1 && (this.D_(), this.S_(`Connection failed 1 times. Most recent error: ${e.toString()}`), this.w_("Offline")));
  }
  set(e) {
    this.D_(), this.f_ = 0, "Online" === e && (this.p_ = false), this.w_(e);
  }
  w_(e) {
...
class __PRIVATE_RemoteStoreImpl {
  constructor(e, t, n, r2, i) {
    this.localStore = e, this.datastore = t, this.asyncQueue = n, this.remoteSyncer = {}, this.C_ = [], this.v_ = /* @__PURE__ */ new Map(), this.F_ = /* @__PURE__ */ new Set(), this.M_ = [], this.x_ = i, this.x_.so((e2) => {
      n.enqueueAndForget(async () => {
        __PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug("RemoteStore", "Restarting streams for network reachability change."), await async function __PRIVATE_restartNetwork(e3) {
          ...
          t2.F_.add(4), await __PRIVATE_disableNetworkInternal(t2), t2.O_.set("Unknown"), t2.F_.delete(4), await __PRIVATE_enableNetworkInternal(t2);
        }(this));
      });
...
function __PRIVATE_remoteStoreListen(e, t) {
  const n = __PRIVATE_debugCast(e);
  n.v_.has(t.targetId) || (n.v_.set(t.targetId, t), __PRIVATE_shouldStartWatchStream(n) ? __PRIVATE_startWatchStream(n) : __PRIVATE_ensureWatchStream(n).Yo() && __PRIVATE_sendWatchRequest(n, t));
}
function __PRIVATE_remoteStoreUnlisten(e, t) {
  const n = __PRIVATE_debugCast(e), r2 = __PRIVATE_ensureWatchStream(n);
  n.v_.delete(t), r2.Yo() && __PRIVATE_sendUnwatchRequest(n, t), 0 === n.v_.size && (r2.Yo() ? r2.e_() : __PRIVATE_canUseNetwork(n) && n.O_.set("Unknown"));
}
...
async function __PRIVATE_onWatchStreamClose(e, t) {
  __PRIVATE_cleanUpWatchStreamState(e), __PRIVATE_shouldStartWatchStream(e) ? (e.O_.b_(t), __PRIVATE_startWatchStream(e)) : e.O_.set("Unknown");
}
async function __PRIVATE_onWatchStreamChange(e, t, n) {
  if (e.O_.set("Online"), t instanceof __PRIVATE_WatchTargetChange && 2 === t.state && t.cause)
    try {
    ...
    try {
      ...
      n.compareTo(t2) >= 0 && await function __PRIVATE_raiseWatchSnapshot(e2, t3) {
        ...
        return n2.targetChanges.forEach((n3, r2) => {
          ...
          if (!r2)
            return;
          e2.v_.set(t4, r2.withResumeToken(ByteString.EMPTY_BYTE_STRING, r2.snapshotVersion)), __PRIVATE_sendUnwatchRequest(e2, t4);
...
async function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
  if (!__PRIVATE_isIndexedDbTransactionError(t))
    throw t;
  e.F_.add(1), await __PRIVATE_disableNetworkInternal(e), e.O_.set("Offline"), n || (n = () => __PRIVATE_localStoreGetLastRemoteSnapshotVersion(e.localStore)), e.asyncQueue.enqueueRetryable(async () => {
    __PRIVATE_logDebug("RemoteStore", "Retrying IndexedDB access"), await n(), e.F_.delete(1), await __PRIVATE_enableNetworkInternal(e);
  });
}
...
async function __PRIVATE_onWriteStreamClose(e, t) {
  t && __PRIVATE_ensureWriteStream(e).I_ && await async function __PRIVATE_handleWriteError(e2, t2) {
    if (function __PRIVATE_isPermanentWriteError(e3) {
      return __PRIVATE_isPermanentError(e3) && e3 !== D.ABORTED;
    }(t2.code)) {
      const n = e2.C_.shift();
      __PRIVATE_ensureWriteStream(e2).Xo(), await __PRIVATE_executeWithRecovery(e2, () => e2.remoteSyncer.rejectFailedWrite(n.batchId, t2)), await __PRIVATE_fillWritePipeline(e2);
    }
...
async function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
  ...
  n.F_.add(3), await __PRIVATE_disableNetworkInternal(n), r2 && n.O_.set("Unknown"), await n.remoteSyncer.handleCredentialChange(t), n.F_.delete(3), await __PRIVATE_enableNetworkInternal(n);
}
async function __PRIVATE_remoteStoreApplyPrimaryState(e, t) {
  const n = __PRIVATE_debugCast(e);
  t ? (n.F_.delete(2), await __PRIVATE_enableNetworkInternal(n)) : t || (n.F_.add(2), await __PRIVATE_disableNetworkInternal(n), n.O_.set("Unknown"));
}
function __PRIVATE_ensureWatchStream(e) {
  return e.B_ || (e.B_ = function __PRIVATE_newPersistentWatchStream(e2, t, n) {
    ...
    t ? (e.B_.Xo(), __PRIVATE_shouldStartWatchStream(e) ? __PRIVATE_startWatchStream(e) : e.O_.set("Unknown")) : (await e.B_.stop(), __PRIVATE_cleanUpWatchStreamState(e));
  })), e.B_;
}
function __PRIVATE_ensureWriteStream(e) {
  return e.L_ || (e.L_ = function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    const r2 = __PRIVATE_debugCast(e2);
    ...
    t ? (e.L_.Xo(), await __PRIVATE_fillWritePipeline(e)) : (await e.L_.stop(), e.C_.length > 0 && (__PRIVATE_logDebug("RemoteStore", `Stopping write stream with ${e.C_.length} pending writes`), e.C_ = []));
  })), e.L_;
}
/**
 * @license
...
class __PRIVATE_DocumentChangeSet {
  ...
  track(e) {
    ...
    n ? 0 !== e.type && 3 === n.type ? this.k_ = this.k_.insert(t, e) : 3 === e.type && 1 !== n.type ? this.k_ = this.k_.insert(t, {
      type: n.type,
      doc: e.doc
      ...
      type: 2,
      doc: e.doc
    }) : fail() : this.k_ = this.k_.insert(t, e);
  }
  q_() {
    const e = [];
...
async function __PRIVATE_eventManagerListen(e, t) {
  ...
  if (n.queries.set(r2, s), s.listeners.push(t), t.U_(n.onlineState), s.Q_) {
...
class __PRIVATE_QueryListener {
  constructor(e, t, n) {
    this.query = e, this.G_ = t, this.z_ = false, this.j_ = null, this.onlineState = "Unknown", this.options = n || {};
  }
  W_(e) {
...
class __PRIVATE_View {
  constructor(e, t) {
    this.query = e, this.oa = t, this._a = null, this.hasCachedResults = false, this.current = false, this.aa = __PRIVATE_documentKeySet(), this.mutatedKeys = __PRIVATE_documentKeySet(), this.ua = __PRIVATE_newQueryComparator(e), this.ca = new DocumentSet(this.ua);
  }
  get la() {
    return this.oa;
  }
    ...
    if (e.inorderTraversal((e2, t2) => {
      ...
      if (u && c) {
        u.data.isEqual(c.data) ? l2 !== h && (n.track({
          ...
          type: 2,
          doc: c
        }), P2 = true, (_ && this.ua(c, _) > 0 || a && this.ua(c, a) < 0) && (o = true));
      } else
        !u && c ? (n.track({
          type: 0,
          doc: c
...
class LimboResolution {
  constructor(e) {
    this.key = e, this.ma = false;
  }
}
class __PRIVATE_SyncEngineImpl {
  constructor(e, t, n, r2, i, s) {
    this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r2, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.fa = {}, this.ga = new ObjectMap((e2) => __PRIVATE_canonifyQuery(e2), __PRIVATE_queryEquals), this.pa = /* @__PURE__ */ new Map(), this.ya = /* @__PURE__ */ new Set(), this.wa = new SortedMap(DocumentKey.comparator), this.Sa = /* @__PURE__ */ new Map(), this.ba = new __PRIVATE_ReferenceSet(), this.Da = {}, this.Ca = /* @__PURE__ */ new Map(), this.va = __PRIVATE_TargetIdGenerator.Ln(), this.onlineState = "Unknown", this.Fa = void 0;
  }
  get isPrimaryClient() {
    return true === this.Fa;
  }
...
async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r2, i) {
  e.Ma = (t2, n2, r3) => async function __PRIVATE_applyDocChanges(e2, t3, n3, r4) {
    ...
    i2.es && (i2 = await __PRIVATE_localStoreExecuteQuery(
      e2.localStore,
      t3.query,
      false
...
async function __PRIVATE_syncEngineApplyRemoteEvent(e, t) {
  ...
  try {
    ...
    t.targetChanges.forEach((e3, t2) => {
      ...
      r2 && (__PRIVATE_hardAssert(e3.addedDocuments.size + e3.modifiedDocuments.size + e3.removedDocuments.size <= 1), e3.addedDocuments.size > 0 ? r2.ma = true : e3.modifiedDocuments.size > 0 ? __PRIVATE_hardAssert(r2.ma) : e3.removedDocuments.size > 0 && (__PRIVATE_hardAssert(r2.ma), r2.ma = false));
...
async function __PRIVATE_syncEngineRejectListen(e, t, n) {
  ...
  if (s) {
    ...
    await __PRIVATE_syncEngineApplyRemoteEvent(r2, i2), r2.wa = r2.wa.remove(s), r2.Sa.delete(t), __PRIVATE_pumpEnqueuedLimboResolutions(r2);
  } else
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  ...
  if (e.pa.delete(t), e.isPrimaryClient) {
    e.ba.mr(t).forEach((t2) => {
      e.ba.containsKey(t2) || __PRIVATE_removeLimboTarget(e, t2);
    });
  }
}
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r2 of n)
    if (r2 instanceof __PRIVATE_AddedLimboDocument)
      ...
      e.ba.containsKey(r2.key) || __PRIVATE_removeLimboTarget(e, r2.key);
    } else
      fail();
}
...
async function __PRIVATE_syncEngineHandleCredentialChange(e, t) {
  ...
  if (!n.currentUser.isEqual(t)) {
    ...
    }(n, "'waitForPendingWrites' promise is rejected due to a user change."), n.sharedClientState.handleUserChange(t, e2.removedBatchIds, e2.addedBatchIds), await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(n, e2.cs);
  }
}
...
class OnlineComponentProvider {
  ...
  terminate() {
    return async function __PRIVATE_remoteStoreShutdown(e) {
      const t = __PRIVATE_debugCast(e);
      __PRIVATE_logDebug("RemoteStore", "RemoteStore shutting down."), t.F_.add(5), await __PRIVATE_disableNetworkInternal(t), t.x_.shutdown(), t.O_.set("Unknown");
    }(this.remoteStore);
  }
}
/**
...
class Transaction$2 {
  ...
  async lookup(e) {
    if (this.ensureCommitNotCalled(), this.mutations.length > 0)
      throw new FirestoreError(D.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
...
class __PRIVATE_TransactionRunner {
  constructor(e, t, n, r2, i) {
    this.asyncQueue = e, this.datastore = t, this.options = n, this.updateFunction = r2, this.deferred = i, this.za = n.maxAttempts, this.Ho = new __PRIVATE_ExponentialBackoff(this.asyncQueue, "transaction_retry");
  }
  run() {
    this.za -= 1, this.ja();
  }
...
class __PRIVATE_AsyncQueueImpl {
  constructor() {
    this.Za = Promise.resolve(), this.Xa = [], this.eu = false, this.tu = [], this.nu = null, this.ru = false, this.iu = false, this.su = [], this.Ho = new __PRIVATE_ExponentialBackoff(this, "async_queue_retry"), this.ou = () => {
  ...
  enqueueAfterDelay(e, t, n) {
    this._u(), this.su.indexOf(e) > -1 && (t = 0);
...
class __PRIVATE_ParseContextImpl {
  constructor(e, t, n, r2, i, s) {
    this.settings = e, this.databaseId = t, this.serializer = n, this.ignoreUndefinedProperties = r2, void 0 === i && this.du(), this.fieldTransforms = i || [], this.fieldMask = s || [];
  }
  get path() {
...
function __PRIVATE_parseDocumentIdValue(e, t, n) {
  if ("string" == typeof (n = getModularInstance(n))) {
    ...
    if (!DocumentKey.isDocumentKey(r2))
      throw new FirestoreError(D.INVALID_ARGUMENT, `Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${r2}' is not because it has an odd number of segments (${r2.length}).`);
...
function __PRIVATE_validateNewFieldFilter(e, t) {
  if (t.isInequality()) {
    ...
    if (null !== n2 && !n2.isEqual(r2))
      throw new FirestoreError(D.INVALID_ARGUMENT, `Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '${n2.toString()}' and '${r2.toString()}'`);
...
function __PRIVATE_validateOrderByAndInequalityMatch(e, t, n) {
  if (!n.isEqual(t))
    throw new FirestoreError(D.INVALID_ARGUMENT, `Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '${t.toString()}' and so you must also use '${t.toString()}' as your first argument to orderBy(), but your first orderBy() is on field '${n.toString()}' instead.`);
}
...
!function __PRIVATE_registerFirestore(e, t = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(w, "4.1.3", e), registerVersion(w, "4.1.3", "esm2017");
}();
var name = "firebase";
var version = "10.3.1";
/**
...
const registrarConCorreoContrasena = (email, password) => {
  return createUserWithEmailAndPassword(auth, email, password);
};
const UsuarioConSesionActiva = (email, password) => {
  return signInWithEmailAndPassword(auth, email, password);
};
const createPostProgrammingWall = (obj) => {
  if (auth.currentUser) {
    const newObj = {
      ...obj,
      email: auth.currentUser.email
    };
    return addDoc(collection(db, "posts"), newObj).then((docRef) => {
      return docRef;
    }).catch((error2) => {
      console.error("Error al agregar el documento: ", error2);
      throw error2;
    });
  }
};
...
const deletePost = (postId) => deleteDoc(doc(db, "posts", postId));
const editPost = (postEditarId, updatedData) => {
...
function login(navigateTo2) {
  ...
  inputPass.placeholder = "Ingresa Contrase\xF1a";
  ...
  buttonLogin.addEventListener("click", () => {
    ...
    if (passwordValue.length < 7) {
      alert("la contrase\xF1a debe tener m\xEDnimo 7 caracteres");
    }
    UsuarioConSesionActiva(emailValue, passwordValue).then((userCredential) => {
      navigateTo2("/programmingWall");
    }).catch((error2) => {
      const errorCode = error2.code;
      if (errorCode === "auth/user-not-found") {
        alert("Usuario no encontrado");
      } else if (errorCode === "auth/wrong-password") {
        alert("Verifica contrase\xF1a");
      }
    });
  });
  ...
  sectionOne.append(title, inputEmail, inputPass, buttonLogin, buttonGoogle, registerbutton);
  return sectionOne;
}
function error() {
  const title = document.createElement("h1");
...
function programmingWall(navigateTo2) {
  const section = document.createElement("section");
  section.classList.add("sectionPost");
  const title = document.createElement("h1");
  title.textContent = "Muro de programaci\xF3n";
  title.classList.add("titlePost");
  const labelPost = document.createElement("label");
  labelPost.textContent = "Escribe tu pregunta de programaci\xF3n";
  ...
  buttonCrear.addEventListener("click", () => {
    ...
    createPostProgrammingWall(newPost).then((docRef) => {
      textAreaPost.value = "";
    }).catch((error2) => {
      console.error("Error al agregar el documento: ", error2);
    });
  ...
  getPosts((querySnapshot) => {
    ...
    querySnapshot.forEach((doc2) => {
      const objPost = {
        ...
        date: doc2.data().date,
        text: doc2.data().text,
        usersWhoLiked: doc2.data().email,
        likes: doc2.data().likesCount
      };
      posts.push(objPost);
    });
    posts.forEach((post) => {
      ...
      btnLike.addEventListener("click", async (e) => {
        ...
        try {
          ...
          console.log('Se ha dado "Me gusta" a la publicaci\xF3n correctamente.');
        } catch (error2) {
          console.error("Error al dar 'Me gusta' a la publicaci\xF3n:", error2);
        }
      });
      ...
      buttonEdit.addEventListener("click", (e) => {
        const postEditarId = e.target.id;
        const sectionPost2 = e.target.parentElement;
        console.log(e);
        const textOriginal = sectionPost2.querySelector(".contenidoPost p");
        if (textOriginal) {
          ...
          textEditPost.value = textOriginal.textContent;
          console.log("ingresar texto");
          const buttonUpdate = document.createElement("button");
          buttonUpdate.textContent = "Guardar Cambios";
          buttonUpdate.classList.add("buttonUpdate");
          sectionPost2.innerHTML = "";
          sectionPost2.append(textEditPost, buttonUpdate);
          buttonUpdate.addEventListener("click", () => {
            const updatedText = textEditPost.value;
            const updatedData = {
              text: updatedText
            };
            editPost(postEditarId, updatedData).then(() => {
              const updatedTextElement = document.createElement("p");
              updatedTextElement.textContent = updatedText;
              sectionPost2.innerHTML = "";
              sectionPost2.append(updatedTextElement, btnLike, buttonEdit, buttonDelete);
            }).catch((error2) => {
              console.error("Error al actualizar la publicaci\xF3n:", error2);
            });
          });
        }
      });
      ...
      buttonDelete.addEventListener("click", (e) => {
        const confirmacion = confirm("\xBFEst\xE1s seguro de que deseas eliminar este post?");
        if (confirmacion) {
          const postIdToDelete = e.target.id;
          console.log(e.target.id);
          console.log(e);
          deletePost(postIdToDelete).then(() => {
            sectionPost.remove();
            console.log("Post eliminado con \xE9xito");
          }).catch((error2) => {
            console.error("Error al eliminar el post:", error2);
          });
        }
      });
...
function register(navigateTo2) {
  ...
  botonRegistro.addEventListener("click", () => {
    ...
    registrarConCorreoContrasena(emailValue, passwordValue).then((userCredential) => {
      ...
      if (errorCode === "auth/email-already-in-use") {
        alert("Correo electr\xF3nico ya en uso");
  ...
  sectionOne.append(inputnombre, title, inputEmail, inputPass, botonRegistro);
  return sectionOne;
}
function welcome(navigateTo2) {
